...
// File contracts/OracleMaker.sol
...
contract OracleMaker is Ownable {
    ...
    // F6: There is an exploit to add lots of ORACLE to the bar, run convert, then remove the ORACLE again.
    //     As the size of the OracleBar has grown, this requires large amounts of funds and isn't super profitable anymore
